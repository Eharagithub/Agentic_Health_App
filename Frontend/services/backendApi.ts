...
const api: AxiosInstance = axios.create({
  baseURL: BACKEND_BASE_URL.replace(':8001', ':8000'), // Points to Prompt Processor
  timeout: 30000,
  headers: {
...
// Create instance for Orchestration Agent (8001)
const orchestrationApi: AxiosInstance = axios.create({
  baseURL: BACKEND_BASE_URL, // Points to Orchestration Agent (8001)
  timeout: 30000,
  headers: {
    'Content-Type': 'application/json',
    'Accept': 'application/json'
...
// Request interceptor for retry configuration
...
/**
 * Main chat orchestration function that:
